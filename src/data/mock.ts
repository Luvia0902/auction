...
export const MOCK_PROPERTIES: Property[] = [
    ...
    {
        id: 'chb_mock_1',
        address: '彰化縣彰化市大埔路 123 號',
        city: '彰化縣', district: '彰化市',
        lat: 24.0689, lng: 120.5424,
        court: '彰化銀行', caseNumber: '113年彰銀字第001號',
        org: '銀行代處分', auctionRound: 1,
        auctionDate: '2026-04-10', auctionTime: '10:00',
        basePrice: 8500000, estimatedPrice: 11000000,
        propertyType: '電梯大樓', area: 35.2, buildAge: 15, floor: '5F',
        delivery: 'delivery',
        riskLevel: 'low',
        riskItems: [{ type: 'clear', label: '銀行件風險低', level: 'low' }],
        imageUrls: ['https://placehold.co/600x400/1E293B/3D7EFF?text=彰銀大埔路物件'],
        aiSummary: '彰銀代處分物件，產權清楚，銀行直接處理，風險極低。',
        isWatched: false,
    },
    {
        id: 'chb_mock_2',
        address: '彰化縣員林市中山路二段 50 號',
        city: '彰化縣', district: '員林市',
        lat: 23.9589, lng: 120.5696,
        court: '彰化銀行', caseNumber: '113年彰銀字第002號',
        org: '銀行代處分', auctionRound: 2,
        auctionDate: '2026-04-12', auctionTime: '14:00',
        basePrice: 12000000, estimatedPrice: 15000000,
        propertyType: '透天厝', area: 52.5, buildAge: 20, floor: '1-3F',
        delivery: 'delivery',
        riskLevel: 'low',
        riskItems: [{ type: 'clear', label: '點交案件', level: 'low' }],
        imageUrls: ['https://placehold.co/600x400/1E293B/3D7EFF?text=彰銀員林透天'],
        aiSummary: '精華區透天，銀行債權處理案件。',
        isWatched: false,
    },
];
